...
import com.prebel.prototipo.webapp.repositories.WeeklyCalendarRepository;
...
public class WeeklyCalendarController {
    ...
    // Nuevo endpoint para obtener todas las tareas con filtros opcionales
    @GetMapping("/filter")
    ...
    // Nuevo endpoint para obtener tareas combinadas (rol + usuario)
