...
public class pH {
    ...
    public pH(String unit, String specification, String method, String initialResultsDevelopmentLaboratory, String initialResultsStabilityLaboratory, int time, int equipment) {
        this.unit = unit;
